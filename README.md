...
This is a fix for pillarboxing in cutscenes with ultrawide/wider displays in Octopath Traveler 2.
...
- Extract the contents of the release zip in to the game directory.<br />(e.g. "**steamapps\common\Octopath Traveler 2**" for Steam).
